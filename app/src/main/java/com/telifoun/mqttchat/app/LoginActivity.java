...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     * dùng để user login vào màn hình chính
     */
            ...
            MqttChat.getInstance().logIn(getApplication(), Integer.parseInt(userId), new CallbackListener() {
                ...
                public void onSuccess(Object o) {
                    MqttChat.getInstance().Connect(new CallbackListener() {
                        // nếu login thành công sẽ chuyển đến màn hình main
                        @Override
                        public void onSuccess(Object o) {
                        ...
                        // nếu login có lỗi sẽ show toast lỗi và chuyển sang màn main
                        @Override
                ...
                // nếu login có sẽ hiển thị lỗi ở ô nhập userId
                @Override
                public void onError(String s) {
                    signInBtn.setEnabled(true);
                    mUserId.setError(s);
